...
from kakao_map_crawler.util.extractor import extract_reviews
...
with SetupBrowserEnvironment() as browser:
    ...
    query_result = postgresql_manager.find(table_name='place', columns=['place_name'])
    ...
    for location_name in location_names:
        ...
        try:
            reviews = extract_reviews(browser, restaurant_id=place_info['id'])
